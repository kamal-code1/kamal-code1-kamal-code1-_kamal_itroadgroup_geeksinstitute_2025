...
// Remove the private key environment variable parsing and instead load the Firebase service account JSON file
...
try {
  ...
  throw new Error(`Failed to load Firebase service account JSON file at ${serviceAccountPath}: ${error.message}`);
}
